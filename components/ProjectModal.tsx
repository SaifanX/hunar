  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-10 animate-in fade-in duration-300">
      <div 
        ...
        onClick={onClose}
      />
      <div className="relative w-full max-w-6xl bg-white overflow-hidden shadow-2xl flex flex-col md:flex-row max-h-[95vh] animate-in slide-in-from-bottom-8 duration-500">
        <button 
          onClick={onClose}
